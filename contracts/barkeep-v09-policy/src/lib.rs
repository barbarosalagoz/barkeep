...
//!
//! **This contract is not audited.** See `docs/ARCHITECTURE-v2.md` §4.1. Built on
//! the unpublished `stellar-accounts` commit `4529d70`; the `=0.7.2` crate without
//! `-v09` is the deployed baseline.
//!
