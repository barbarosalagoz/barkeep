...
//!
//! Mirror of the `-v09`-less crate, built on `stellar-accounts` commit `4529d70`
//! so a 0.9.0-line account has a verifier from the same library build.
//!
//! `stellar-accounts` (here at commit `4529d70`, #868) ships the verification *logic* as plain functions in
